...
class ProposalCreator:
    ...
    def __call__(self, score: torch.Tensor, loc: torch.Tensor, anchor: torch.Tensor, gt_bbox: torch.Tensor, gt_label: torch.Tensor, img_size: Tuple[int, int]):
        """[summary]
        ...
        iou = iou[inside_index]
        iou_maximum = iou_maximum[inside_index]
        bbox_idx = bbox_idx[inside_index]
